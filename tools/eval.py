...
parser.add_argument('--trained_model',
                    default='work_dir/SSD300_VOC_FPN_GIOU/ssd231_.pth', type=str,
...
if __name__ == '__main__':
    ...
    # load data
    dataset = VOCDetection(args.voc_root, image_sets = [('2007', 'val')],
                           transform = BaseTransform(300, voc['mean'],voc['std']))
    if args.cuda:
        net = net.cuda()
    ...
    result = evaluate_detections(devkit_path,all_boxes, dataset,'val')
